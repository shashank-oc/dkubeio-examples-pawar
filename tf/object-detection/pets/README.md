...
4. **Inference**
    - One image is provided in the inference-images folder, if you want inference for other images too, please copy all the images to the inference-images folder inside tf-notebooks.
